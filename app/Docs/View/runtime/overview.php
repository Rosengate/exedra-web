...
<p>On the construct of this context, as a container itself, by defaults register number of dependencies, initialize empty response, and build a calls stack from an array of middlewares and the runtime handle retrieved from the finding, before executing the stack and set the response body in order.</p>
...
<ol>
	...
	<li>A middleware applied <span class='label label-class'>\App\Middleware\All</span> is bound internally to the route. This middleware will be applied to every route within the same group.</li>
