...
<p>As a microframework, there aren't much services/components you can expect. It's an alternative to anyone who seeks much minimal design yet expandable, a container, route/resource oriented capable microframework.</p>
...
<p>Most of the convenient interfaces are already http verb oriented, the rest is designing the response, authentication, application design which is all up to developers themselves. Most of the examples shown are usually resourceful as you can see.</p>