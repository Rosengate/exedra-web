...
<p>A utility service that help you do a route oriented redirection.</p>
<h2>route</h2>
<p>This method at it's core uses url factory. So, the first parameter would be tied relatively to current execution context.</p>
...
<pre><code>
return $exe->redirect->route('user.update');
	</code></pre>
<p>At <b class='label label-route'>backend.dashboard</b> to <b class='label label-route'>public.user.view</b></p>
<pre><code>
return $exe->redirect->route('@public.user.view', ['username'=> 'eimihar']);
</code></pre>
<h5>Tagged route example</h5>
<pre><code>
return $exe->redirect->route('#userView', ['username' => 'eimihar']);
</code></pre>
<h2>url</h2>
<p>This method redirects to the given url.</p>
<pre><code>
return $exe->redirect->url('http://www.google.com.my');
</code></pre>
<h2>refresh</h2>
