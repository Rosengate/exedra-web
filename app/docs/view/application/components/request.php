<h1>HTTP Request</h1>
<p>HTTP request actually live in the scope of exedra itself, but is retrievable through the application instance, or the exe instance itself. This is to ease the developer on writing too long chain of instances, in order to just get this component.</p>
<h2>1. get</h2>
