...
<p>Exedra's folder structure is simple that they're highly depending on how you design the structure using this <b>\Exedra\Application\Structure</b> instance. Example of structure :</p>
<pre><code>
app
  config
  view
